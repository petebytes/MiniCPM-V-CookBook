...
- __Download the dataset__: the data source is [allenai/pixmo-count](https://huggingface.co/datasets/allenai/pixmo-count). After downloading the dataset and image files, convert the dataset into the LlamaFactory format.
  ...
  - __Notes__:
    ...
    - When training with LlamaFactory, you also need to provide the corresponding `dataset_info.json`.
